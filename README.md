...
| Path | Contents |
|------|----------|
| `docs/Throbbin Abbey_GDD_v4.1.md` | Full game design document |
...
| `docs/Throbbin Abbey_Handoff_Overview.md` | Original handoff summary and next steps |
